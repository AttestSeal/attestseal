...
def generate_checklist(signals: SignalBundle, is_registered: bool = False) -> list[dict]:
    ...
    items.append({
        "category": "Identity",
        "item": "Registered with AttestSeal",
        "status": "pass" if is_registered else "available",
        "impact": "high",
        "fix": "Register your domain at attestseal.com/register.html to prove ownership and provide business details. Each verified field earns points (up to +30). Free registration.",
    })
