...
echo "Deploying AttestSeal to $VPS..."
...
ssh "$VPS" "mkdir -p /opt/attestseal/logs && chown -R ats:ats /opt/attestseal/logs"

# Restart service
ssh "$VPS" "systemctl restart attestseal && echo 'Service restarted'"
