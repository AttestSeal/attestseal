"""AttestSeal client - sync and async HTTP client."""

import httpx
from .models import CheckResult, _parse_response

DEFAULT_BASE_URL = "https://api.attestseal.com"
DEFAULT_TIMEOUT = 30


class OTSClient:
    """AttestSeal API client.
    ...
    def __init__(
        ...
        self.headers = {"User-Agent": "attestseal-python/0.1.0"}
        if api_key:
